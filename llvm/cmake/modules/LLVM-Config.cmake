...
function(llvm_expand_pseudo_components out_components)
  ...
  foreach(c ${link_components})
    ...
    if(${c} STREQUAL "X86")
      # TODO: Need to fix target handling.
      message(STATUS "SPECIAL CASED X86")
      list(APPEND expanded_components "X86")
    elseif( NOT idx LESS 0 )
      if( TARGET LLVM${c}CodeGen )
        ...
        if( TARGET LLVM${c} )
          ...
          message(WARNING "Target ${c} is not in the set of libraries.")
        endif()
      endif()
...
function(llvm_map_components_to_libnames out_libs)
  ...
  # TODO: FIX ME!
  list(TRANSFORM expanded_components REPLACE LLVMX86 X86)
