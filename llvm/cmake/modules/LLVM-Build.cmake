...
function(LLVMBuildGenerateCFragment)
  ...
  foreach(llvmbuild_component ${llvmbuild_components})
    if(llvmbuild_component STREQUAL "all")
      ...
      # TODO: Fix me.
      set(llvmbuild_libname "FIXME_llvmbuild_libname")
      set(llvmbuild_libdeps "FIXME_llvmbuild_libdeps")
...
function(LLVMBuildResolveComponentsLink)
  ...
  #   message(STATUS "  ++ Fixup ${llvm_component}")
  ...
  #     message(STATUS "    >> (${libtype}) ${llvm_libs}")
